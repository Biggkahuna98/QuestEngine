...
namespace QE
{
    ...
    StringID StringID::InternString(std::string_view string)
    {
        StringID sid = Utils::djb2(string);
        LOG_DEBUG("Interning string: {} with SID: {}", string.data(), sid.Value);
    ...
    std::string_view StringID::GetStringFromID(StringID id)
    {
